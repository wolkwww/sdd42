...
#define SSP_CR0_DSS(n)   		((u32)((n-1)&0xF))
/** SSP control 0 Motorola SPI mode */
#define SSP_CR0_FRF_SPI  		((u32)(0<<4))
/** SSP control 0 TI synchronous serial mode */
#define SSP_CR0_FRF_TI   		((u32)(1<<4))
/** SSP control 0 National Micro-wire mode */
#define SSP_CR0_FRF_MICROWIRE  	((u32)(2<<4))
/** SPI clock polarity bit (used in SPI mode only), (1) = maintains the
   bus clock high between frames, (0) = low */
#define SSP_CR0_CPOL_HI		((u32)(1<<6))
/** SPI clock out phase bit (used in SPI mode only), (1) = captures data
   on the second clock transition of the frame, (0) = first */
#define SSP_CR0_CPHA_SECOND	((u32)(1<<7))
/** SSP serial clock rate value load macro, divider rate is
   PERIPH_CLK / (cpsr * (SCR + 1)) */
#define SSP_CR0_SCR(n)   	((u32)((n&0xFF)<<8))
/** SSP CR0 bit mask */
#define SSP_CR0_BITMASK		((u32)(0xFFFF))
...
#define SSP_CR1_LBM_EN		((u32)(1<<0))
/** SSP control 1 enable bit */
#define SSP_CR1_SSP_EN		((u32)(1<<1))
/** SSP control 1 slave enable */
#define SSP_CR1_SLAVE_EN	((u32)(1<<2))
/** SSP control 1 slave out disable bit, disables transmit line in slave
   mode */
#define SSP_CR1_SO_DISABLE	((u32)(1<<3))
/** SSP CR1 bit mask */
#define SSP_CR1_BITMASK		((u32)(0x0F))
...
#define SSP_SR_TFE      ((u32)(1<<0))
/** SSP status TX FIFO not full bit */
#define SSP_SR_TNF      ((u32)(1<<1))
/** SSP status RX FIFO not empty bit */
#define SSP_SR_RNE      ((u32)(1<<2))
/** SSP status RX FIFO full bit */
#define SSP_SR_RFF      ((u32)(1<<3))
/** SSP status SSP Busy bit */
#define SSP_SR_BSY      ((u32)(1<<4))
/** SSP SR bit mask */
#define SSP_SR_BITMASK	((u32)(0x1F))
 ...
 **********************************************************************/
/** SSP clock prescaler */
#define SSP_CPSR_CPDVSR(n) 	((u32)(n&0xFF))
/** SSP CPSR bit mask */
#define SSP_CPSR_BITMASK	((u32)(0xFF))
 ...
 **********************************************************************/
/** Receive Overrun */
#define SSP_IMSC_ROR	((u32)(1<<0))
/** Receive TimeOut */
#define SSP_IMSC_RT		((u32)(1<<1))
/** Rx FIFO is at least half full */
#define SSP_IMSC_RX		((u32)(1<<2))
/** Tx FIFO is at least half empty */
#define SSP_IMSC_TX		((u32)(1<<3))
/** IMSC bit mask */
#define SSP_IMSC_BITMASK	((u32)(0x0F))

/*********************************************************************//**
 * Macro define for (RIS) Raw Interrupt Status registers
 **********************************************************************/
/** Receive Overrun */
#define SSP_RIS_ROR		((u32)(1<<0))
/** Receive TimeOut */
#define SSP_RIS_RT		((u32)(1<<1))
/** Rx FIFO is at least half full */
#define SSP_RIS_RX		((u32)(1<<2))
/** Tx FIFO is at least half empty */
#define SSP_RIS_TX		((u32)(1<<3))
/** RIS bit mask */
#define SSP_RIS_BITMASK	((u32)(0x0F))
 ...
 **********************************************************************/
/** Receive Overrun */
#define SSP_MIS_ROR		((u32)(1<<0))
/** Receive TimeOut */
#define SSP_MIS_RT		((u32)(1<<1))
/** Rx FIFO is at least half full */
#define SSP_MIS_RX		((u32)(1<<2))
/** Tx FIFO is at least half empty */
#define SSP_MIS_TX		((u32)(1<<3))
/** MIS bit mask */
#define SSP_MIS_BITMASK	((u32)(0x0F))
...
#define SSP_ICR_ROR		((u32)(1<<0))
/** Writing a 1 to this bit clears the "Rx FIFO was not empty and
 * has not been read for a timeout period" interrupt */
#define SSP_ICR_RT		((u32)(1<<1))
/** ICR bit mask */
#define SSP_ICR_BITMASK	((u32)(0x03))
...
#define SSP_DMA_RXDMA_EN  	((u32)(1<<0))
/** SSP bit for enabling TX DMA */
#define SSP_DMA_TXDMA_EN  	((u32)(1<<1))
/** DMACR	bit mask */
#define SSP_DMA_BITMASK		((u32)(0x03))
...
typedef struct {
	...
	u32 tx_cnt;			/**< Transmit counter */
	void *rx_data;				/**< Pointer to transmit data */
	u32 rx_cnt;			/**< Receive counter */
	u32 length;			/**< Length of transfer data */
	u32 status;			/**< Current status of SSP activity */
...
#define PARAM_SSPx(n)	((((u32 *)n)==((u32 *)LPC_SSP0)) \
|| (((u32 *)n)==((u32 *)LPC_SSP1)))
